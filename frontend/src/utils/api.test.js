/**
 * Tests unitaires pour utils/api.js — couvre les chemins critiques :
 * - lecture du JSON normal
 * - propagation du `detail` envoyé par FastAPI
...
describe('apiGet', () => {
  ...
  it('détecte les réponses 200 + { detail: "..." } legacy', async () => {
