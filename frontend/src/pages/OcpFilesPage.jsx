...
export default function OcpFilesPage({ apiFetch, onNavigate }) {
  ...
  return (
    <div style={{ maxWidth:1180, margin:'0 auto', padding:'34px 28px', color:'#2A2A1E' }}>
      ...
      <p className="page-subtitle" style={{ color:'#8A7D60' }}>Importez un seul fichier Excel capteurs; il alimente ensuite Défauts, Santé, Prédiction LSTM et Alertes.</p>
      ...
      {uploaded && (
        <div style={{ display:'flex', gap:12, justifyContent:'center', marginTop:28 }}>
          ...
          <button onClick={() => onNavigate?.('prediction')} className="btn btn-primary">📈 Prédiction LSTM →</button>
        </div>
      )}
